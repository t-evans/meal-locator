...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'locations_maplocation', (
        ...
        db.send_create_signal(u'locations', ['MapLocation'])

        # Adding model 'LocationDetailSection'
        db.create_table(u'locations_locationdetailsection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('map_location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='location_detail_sections', to=orm['locations.MapLocation'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'locations_maplocation')
    ...
    models = {
        u'locations.locationdetailsection': {
            ...
            'map_location': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'location_detail_sections'", 'to': u"orm['locations.MapLocation']"}),
            'notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'order': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'sub_header': ('django.db.models.fields.CharField', [], {'max_length': '80', 'blank': 'True'})
        },
        u'locations.maplocation': {
